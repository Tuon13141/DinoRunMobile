...
public class GameController : MonoBehaviour
{
    ...
    public GameObject textGuildLeft;
    public GameObject textGuildRight;
    ...
    IEnumerator SpawnObstacles()
    {
        ...
        {
            if(textGuildLeft != null)
            {
                //textGuildLeft.SetActive(true);
            }
    ...
    private void ZoomCamera()
    {
        if (ChangeCameraSize)
        {
            if (mainCamera.orthographicSize < 3f) //3f
            {
        ...
        {
            if (mainCamera.orthographicSize > 2.6f) //2.6f
            {
                mainCamera.orthographicSize -= 1f * Time.deltaTime;
            }
            else
    ...
    private IEnumerator Scoring()
    {
        ...
        if(Score >= nextScore && SpeedSetting.movingToLeftSpeed <= SpeedSettingDefault.maxSpeed)
        {
            ...
            //DinoRB.mass += SpeedSettingDefault.dino_Mass_acceleration;
